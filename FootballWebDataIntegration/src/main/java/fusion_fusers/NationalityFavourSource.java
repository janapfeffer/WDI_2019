 ...
 * @author group3
 * 
 * Fusion of the nationality using the source scores.
 */
public class NationalityFavourSource extends AttributeValueFuser<String, Player, Attribute>{

	public NationalityFavourSource() {
